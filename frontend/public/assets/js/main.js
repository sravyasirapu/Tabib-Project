$(function () {
    ...
    // ========================================================================= //
    //    Add remove class active has menu (✅ FIXED)
    // ========================================================================= //

    jQuery(".has-submenu > a").on("click", function (e) {
        e.stopPropagation(); // ✅ Prevents blocking other links
    ...
    // ========================================================================= //
    //    Set attribute inside body (Light)
    // ========================================================================= //
    ...
    // ========================================================================= //
    //    Set attribute inside body (Dark)
    // ========================================================================= //
    ...
    var structure = `   
        <form id="testmed">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    <div class="form-group">
                        <select class="form-control form-select">
                            ...
                            <option value="19">csdfsff</option>
                            <option value="20">test trade name</option>
                        </select> 
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Mg/Ml">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Advice/Comment">
                    </div>
                </div>
            </div>
        </form>
...
// ========================================================================= //
//   refresh select picker inside modal
// ========================================================================= //
...
// ========================================================================= //
// ✅ FIX: GUARANTEE HEADER LINKS ALWAYS WORK
// ========================================================================= //

$(document).on("click", ".content-header__menu a, .top-head a", function () {
